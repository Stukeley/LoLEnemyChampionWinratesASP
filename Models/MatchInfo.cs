...
//
//    var matchInfo = MatchInfo.FromJson(jsonString);
...
namespace LoLEnemyChampionWinratesASP.Models
{
    ...
    public partial class MatchInfo
    {
        public static MatchInfo FromJson(string json) => JsonConvert.DeserializeObject<MatchInfo>(json, LoLEnemyChampionWinratesASP.Helpers.Converter.Settings);
    }

    public static partial class Serialize
    {
        public static string ToJson(this MatchInfo self) => JsonConvert.SerializeObject(self, LoLEnemyChampionWinratesASP.Helpers.Converter.Settings);
    }
